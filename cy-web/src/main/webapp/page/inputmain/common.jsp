...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
            ...
            <div class="layui-input-normal">
                <input type="text"  name="inputmainId" maxlength="20"  value="${model.inputmainId}" lay-verify="required" placeholder="请输入主键ID"  class="layui-input">
            </div>
        </div>
              <div class="layui-form-item">
            ...
            <div class="layui-input-normal">
              ...
              <div class="layui-form-item">
            <label class="layui-form-label">入库单号<span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="inputmainRef" maxlength="100"  value="${model.inputmainRef}" lay-verify="required" placeholder="请输入入库单号"  class="layui-input">
            </div>
        </div>
              <div class="layui-form-item">
            <label class="layui-form-label">入库仓库id<span class="span_must">*</span></label>
            <div class="layui-input-normal">
                <input type="text"  name="warehouseId" maxlength="11"  value="${model.warehouseId}" lay-verify="required" placeholder="请输入入库仓库id"  class="layui-input">
            </div>
        </div>
              <div class="layui-form-item">
