...
<div class="layui-field-box">
    <form class="layui-form" action="">
            ...
            <label class="layui-label-right">${model.companyId}</label>
              ...
              <div class="layui-form-item">
            <label class="layui-label-left">入库单号<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.inputmainRef}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">入库仓库id<span class="label_span">:</span></label>
