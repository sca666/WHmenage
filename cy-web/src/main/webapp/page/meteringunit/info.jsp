...
<div class="layui-field-box">
    <form class="layui-form" action="">
            ...
            <label class="layui-label-right">${model.unitId}</label>
              ...
              <div class="layui-form-item">
            <label class="layui-label-left">单位编码<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.unitcode}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">单位名称<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.unitname}</label>
        </div>
              <div class="layui-form-item">
