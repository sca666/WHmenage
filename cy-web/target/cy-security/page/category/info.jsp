...
<div class="layui-field-box">
    <form class="layui-form" action="">
            ...
            <label class="layui-label-right">${model.categoryId}</label>
              ...
              <div class="layui-form-item">
            <label class="layui-label-left">商品分类编码<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.code}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">商品分类名称<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.name}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">商品分类父类id<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.parentId}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">商品分类全名<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.fullName}</label>
        </div>
              <div class="layui-form-item">
