...
<div class="layui-field-box">
    <form class="layui-form" action="">
            ...
            <label class="layui-label-right">${model.inputapplymainId}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">入库申请表单号<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.inputapplymainRef}</label>
        </div>
              <div class="layui-form-item">
            ...
            <label class="layui-label-right">${model.inputUserId}</label>
        </div>
              <div class="layui-form-item">
