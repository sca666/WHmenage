...
<div class="layui-field-box">
    <form class="layui-form" action="">
            ...
            <label class="layui-label-right">${model.raiserentId}</label>
              ...
              <div class="layui-form-item">
            <label class="layui-label-left">加租类型名称<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.raiserentname}</label>
        </div>
              <div class="layui-form-item">
            <label class="layui-label-left">单价<span class="label_span">:</span></label>
            <label class="layui-label-right">${model.rasierentprice}</label>
        </div>
              <div class="layui-form-item">
