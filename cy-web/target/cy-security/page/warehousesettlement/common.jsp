...
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
            ...
            <div class="layui-input-normal">
                <input type="text"  name="housesetId" maxlength="20"  value="${model.housesetId}" lay-verify="required" placeholder="请输入主键ID"  class="layui-input">
            </div>
        </div>
              <div class="layui-form-item">
            ...
            <div class="layui-input-normal">
                <input type="text"  name="warehoustId" maxlength="11"  value="${model.warehoustId}" lay-verify="required" placeholder="请输入仓库id"  class="layui-input">
            </div>
        </div>
              <div class="layui-form-item">
